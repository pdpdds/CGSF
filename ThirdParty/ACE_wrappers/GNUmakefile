...
$(REMAINING_TARGETS):
	...
	$(KEEP_GOING)@cd protocols/ace/INet && $(MAKE) -f GNUmakefile.HTTPS_Simple_exec $(@)
...
HTTPS_Simple_exec: ACE SSL INet INet_SSL
	$(KEEP_GOING)@cd protocols/ace/INet && $(MAKE) -f GNUmakefile.HTTPS_Simple_exec all

.PHONY: HTTP_Simple_exec
HTTP_Simple_exec: ACE INet HTTPS_Simple_exec
...
Bug_3539_Regression_Test: ACE Test_Output MT_Reactor_Upcall_Test
...
QtReactor_Test: ACE ACE_Qt4Reactor Test_Output MT_Reactor_Upcall_Test
...
Task_Wait_Test: ACE Test_Output MT_Reactor_Upcall_Test
