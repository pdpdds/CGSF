...
SFDatabaseODBC::SFDatabaseODBC(void)
{
...
BOOL SFDatabaseODBC::Initialize(_DBConnectionInfo* pInfo)
{
	return TRUE;
}
...
BOOL SFDatabaseODBC::IsDBConnected()
{
	return IsConnected();
}	

BOOL SFDatabaseODBC::RegisterStatement(SFStatement& statement)
{
...
BOOL SFDatabaseODBC::AddStatement(SFStatement& statement)
{
	if(m_hDbc == SQL_NULL_HANDLE)
		return FALSE;
...
void SFDatabaseODBC::Disconnect()
{
...
BOOL SFDatabaseODBC::GetDBError(LPSTR szMsg, int nBufLen)
{
