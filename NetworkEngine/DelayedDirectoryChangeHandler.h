...
protected:
	...
	void On_FileAdded(const CStdString & strFileName);
	void On_FileRemoved(const CStdString & strFileName);
	void On_FileModified(const CStdString & strFileName);
	void On_FileNameChanged(const CStdString & strOldFileName, const CStdString & strNewFileName);
	void On_ReadDirectoryChangesError(DWORD dwError, const CStdString & strDirectoryName);

	void On_WatchStarted(DWORD dwError, const CStdString & strDirectoryName);
	void On_WatchStopped(const CStdString & strDirectoryName);
	

	void SetChangedDirectoryName(const CStdString & strChangedDirName);
	const CStdString & GetChangedDirectoryName()const;
	...
	void SetPartialPathOffset(const CStdString & strWatchedDirName);
