...
;
; 32bit 는
;   ml.exe -c -Fo$(PlatformName)\$(ConfigurationName)\$(InputName).obj $(InputPath)
;
; 64bit 는
;   ml64.exe -c /Dx64 -Fo$(PlatformName)\$(ConfigurationName)\$(InputName).obj $(InputPath)
;
; outputs 에는 
;   $(PlatformName)\$(ConfigurationName)\$(InputName).obj
